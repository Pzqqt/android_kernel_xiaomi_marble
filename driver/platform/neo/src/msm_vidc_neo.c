...
#define DEFAULT_BITRATE         5500000
#define MINIMUM_FPS             1
#define MAXIMUM_FPS             240
...
#define CODECS_ALL     (H264 | HEVC | HEIC)
...
static struct msm_platform_core_capability core_data_neo[] = {
	...
	{MAX_RT_MBPF, 32400},	/* (3840x2160)/256*/
	{MAX_MBPF, 32400}, /* (3840x2160)/256*/
	{MAX_MBPS, 972000},	/* max_load 13840x2160@30fps */
	...
	{MAX_MBPS_B_FRAME, 972000}, /* 3840x2160/256 MBs@30fps */
	{MAX_MBPS_ALL_INTRA, 972000}, /* 3840x2160/256 MBs@30fps */
...
static struct msm_platform_inst_capability instance_data_neo[] = {
	...
	{MIN_BUFFERS_INPUT, ENC, CODECS_ALL, 0, 64, 1, 4,
		V4L2_CID_MIN_BUFFERS_FOR_OUTPUT},
	{MIN_BUFFERS_OUTPUT, ENC, CODECS_ALL,
		0, 64, 1, 4,
	...
	/* (3840 * 2160) / 256 */
	{MBPF, ENC, CODECS_ALL, 64, 32400, 1, 8160},
	/* (3840 * 2160) / 256 */
	{LOSSLESS_MBPF, ENC, H264|HEVC, 64, 32400, 1, 8160},
	/* ((3840 * 2160) / 256) * 30 fps */
	{MBPS, ENC, CODECS_ALL, 64, 972000, 1, 489600},
	/* ((3840 * 2160) / 256) * 30 fps */
	{POWER_SAVE_MBPS, ENC, CODECS_ALL, 0, 972000, 489600},
	...
	{MIN_BUFFERS_INPUT, ENC, HEIC, 0, 64, 1, 1,
		V4L2_CID_MIN_BUFFERS_FOR_OUTPUT},
